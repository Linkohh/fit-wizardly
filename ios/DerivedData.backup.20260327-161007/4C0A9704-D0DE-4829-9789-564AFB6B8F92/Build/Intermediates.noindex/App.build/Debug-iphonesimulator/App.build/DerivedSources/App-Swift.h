...
@class NSBundle;
@class NSCoder;
SWIFT_RESILIENT_CLASS("_TtC3App23AppBridgeViewController")
...
SWIFT_CLASS_NAMED("MotionTiltPlugin")
@interface MotionTiltPlugin : CAPPlugin <CAPBridgedPlugin>
...
- (void)getStatus:(CAPPluginCall * _Nonnull)call;
- (void)requestPermission:(CAPPluginCall * _Nonnull)call;
- (void)start:(CAPPluginCall * _Nonnull)call;
