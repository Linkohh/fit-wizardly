export const LOCAL_MOTIVATION_QUOTES = [
    // Original quotes
...
export function getDailyQuoteIndex(date: Date, quoteCount = LOCAL_MOTIVATION_QUOTES.length) {
  if (quoteCount <= 0) {
    return 0;
  }

  return (date.getDate() + date.getMonth()) % quoteCount;
}
