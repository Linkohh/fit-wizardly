...
export const EXERCISE_DATABASE: Exercise[] = [
  ...
  },
  {
    ...
    patterns: ['horizontal_push'],
    contraindications: ['shoulder_injury'],
    cues: ['Keep elbows at 45°', 'Touch dumbbells at top', 'Control the descent'],
  },
  {
    id: 'pushup',
    name: 'Push-Up',
    ...
    cues: ['Body in straight line', 'Elbows at 45°', 'Full range of motion'],
  },
  {
    ...
    patterns: ['horizontal_push'],
    contraindications: ['shoulder_injury'],
    cues: ['30-45° incline', 'Drive through chest', 'Squeeze at top'],
  },
  {
    id: 'cable_fly',
    name: 'Cable Fly',
  ...
  },
  {
    ...
    patterns: ['isolation'],
    contraindications: [],
    cues: ['Knees at 90°', 'Full range of motion', 'Slow negatives'],
  },
