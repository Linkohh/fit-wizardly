...
export default function Index() {
  ...
  return (
    <main>
      ...
      <div className="bg-gradient-to-b from-background/80 via-purple-50/10 to-background/70 dark:from-[#0F0518]/80 dark:via-[#0a0210]/60 dark:to-[#05010a]/70 pb-16 pt-8 sm:pt-12 relative z-20 w-full -mt-12 sm:-mt-16 md:-mt-20 transition-colors duration-500">
